package org.xitikit.springboot.environment.test.valuevalue;
    ...
    public void testScan(){
        ...
        types.forEach(
            t -> {
                ...
                assertTrue("Expected one value. Found " + value.length + " values.", value.length == 1);
                assertNotNull("The value was null or empty.", trimToNull(value[0]));
            }
        );
    }
