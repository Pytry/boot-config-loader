 ...
 * Example:
 * \@SpringBootConfigurationFilePath("#{systemProperties['your.jvm.parameter']}")
...
@Documented
public @interface SpringBootConfigurationFilePath{
     ...
     *
     * Example 1:
     *      {@code @SpringBootConfigurationFilePath("../external-properties/my-app.yml")}
     *
     ...
     *
     * Example 2:
     *      {@code @SpringBootConfigurationFilePath("#{systemProperties['my-app.config.path']}?:''")}
     *
